...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-around.align-items-center.p-2.p-md-3
    
      .col-md.col-lg-5
        img(src="@/assets/curso/temas/img-introduccion.png")
    ...
    .row.tarjeta.tarjeta--blanca.p-2.p-md-3
      ...
      figure
        .video
          iframe(width="560" height="315" src="https://www.youtube.com/embed/4PsaVqMeZJY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
